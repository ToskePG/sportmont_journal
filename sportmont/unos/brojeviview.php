...
class cbrojevi_view extends cbrojevi {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_brojevi\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_brojevi',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fbrojeviview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
