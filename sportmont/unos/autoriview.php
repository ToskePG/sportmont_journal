...
class cautori_view extends cautori {
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_autori\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_autori',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.fautoriview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
