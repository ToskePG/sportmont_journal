...
define("EW_ROOT_RELATIVE_PATH", "C:\Users\User\Documents\PHPMaker\Projects\sportmont2", TRUE); // Relative path of app root
...
define("EW_PROJECT_NAME", "sportmont", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{3D7A0815-42DE-4706-A688-045439C7A048}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '003Cp7teVS4a3oB0', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/sportmont.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'sportmont', TRUE);
define("EW_CONN_PASS", 'SMjsP34!2B#', TRUE);
define("EW_CONN_DB", 'sportmont', TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "sportmont", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "sm10sm24", TRUE); // Administrator password
