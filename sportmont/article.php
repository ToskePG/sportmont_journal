...
Sport Mont <?php echo $b_result["godina"]; ?>, <?php echo $b_result["vol"]; ?>(<?php if($b_broj != 38) {
	echo $b_result["no"]; 
}
else{
	echo "S2";
...
<?php if($a_result["id"] == 2034){?>
		<h3>Supplementary Files</h3>
	    <?php echo '<p style="text-align:center;"><span class="artlink"><a href="http://www.sportmont.ucg.ac.me/clanci/Ribnarik_Supplementary.pdf" target="_blank"><img src="images/pdf64.gif" /><br />View Supplementary File<br />(PDF)</a></span></p>';
}
?>
