...
<?php
	...
	if($alc=="autor"){
		...
		$al_query = mysql_query("SELECT * FROM clanci WHERE `autor1`='$alv' OR `autor2`='$alv' OR `autor3`='$alv' OR `autor4`='$alv' OR `autor5`='$alv' OR `autor6`='$alv'") or die(mysql_error());
		...
		$al_query = mysql_query("SELECT * FROM clanci WHERE `broj`='$alv' ORDER BY id ASC") or die(mysql_error());
		echo "<p><img src=\"images/knjigica-3d-1.jpg\" border=\"0\"><br /><b>September 2012, Vol.1, No.1</b></p>";
...
?>
		...
		<?php
			...
			echo "<p><img src=\"images/knjigica-3d-2.jpg\" border=\"0\"><br /><b>March 2013, Vol.2, No.1</b></p>";
			stampaj_listu($al_query);
		?>
			</div>
		</div>
