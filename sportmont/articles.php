...
if ($alc == "past") {
	...
	<div class="faq">
		...
		<div class="answer">
			...
			?>
			<?php
			$al_query = mysql_query("SELECT * FROM clanci WHERE `broj`= 48 ORDER BY id ASC") or die(mysql_error());
			echo "<p><img src=\"images/knjigica_3d_48.jpg\" border=\"0\"><br /><b>June 2024, 22(2) <a href='/download_pdf_arhiva.php/SM_June_2024.pdf' target='_blank'>[print version]</a></b></p>";
			stampaj_listu($al_query);
			?>
			<?php
			$al_query = mysql_query("SELECT * FROM clanci WHERE `broj`= 49 ORDER BY id ASC") or die(mysql_error());
			echo "<p><img src=\"images/knjigica_3d_49.jpg\" border=\"0\"><br /><b>October 2024, 22(3) <a href='/download_pdf_arhiva.php/SM_October_2024.pdf' target='_blank'>[print version]</a></b></p>";
			stampaj_listu($al_query);
			?>
		</div>
	</div>
